start msedge "http://localhost/antrian_puskesmas/play_suara/choosed_lantai/2" --window-position=1920,0 --kiosk --user-data-dir=%TEMP%/monitor1 --autoplay-policy=no-user-gesture-required
