start msedge "http://localhost/antrian_puskesmas/play_suara/choosed_lantai_v2/1" --kiosk --user-data-dir=%TEMP%/monitor1 --autoplay-policy=no-user-gesture-required
