    ...
    <main class="flex justify-center flex-grow overflow-y-auto h-screen custom-scrollbar">
        <div class="max-w-7xl w-full mx-auto p-6">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                ...
                @forelse ($polis as $poli)
                    <div
                        class="bg-white border-2 border-green-600 rounded-xl shadow-md
        ...
        flex flex-col items-center justify-between p-6">
                        ...
                        <div class="flex flex-col items-center">
                            ...
                            <p class="text-sm text-gray-800 mt-1">Lantai: <span
                                    class="font-semibold">{{ $poli->lantai }}</span></p>
                        </div>
                        ...
                        <div class="flex justify-center gap-4 mt-4">
                            ...
                            <a href="{{ route('poli.showQueueByRoom', $poli->id) }}"
                                class="px-6 py-2 bg-green-500 text-white rounded-lg shadow hover:bg-green-600 transition text-center">
                                Antrian Customer
                            </a>
                        </div>
                    </div>
