...
@section('content')
    <main class="flex justify-center flex-grow overflow-y-auto h-screen custom-scrollbar bg-gray-50">
        <div class="max-w-7xl w-full mx-auto p-6 text-center">
            <!-- Title -->
            <h2 class="text-3xl font-bold text-center text-gray-800 tracking-tight">
                Silakan Pilih Poli Antrian
            </h2>

            @forelse ($polis as $lantaiNum => $lantai)
                <h2 class="text-2xl font-bold mb-4 text-gray-800">
                    Ruang Lantai {{ $lantaiNum }}
                </h2>
                <!-- Grid Poli -->
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2">
                    @forelse ($lantai as $poli)
                        <div
