...
alphanumeric.forEach(function (element) {
  ASSETS_TO_CACHE.push("".concat(AUDIO_BASE_URL).concat(element, ".mp3"));
});
...
self.addEventListener("install", function (event) {
  event.waitUntil(_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
    var cache, loaded, _i, _ASSETS_TO_CACHE, file, match, response, _t;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        ...
        case 7:
          _context.p = 7;
          _t = _context.v;
          console.error("Gagal cache:", file, _t);
        case 8:
          loaded++;
    ...
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.n) {
        case 0:
          ...
          console.log((_event$data2 = event.data) === null || _event$data2 === void 0 ? void 0 : _event$data2.type);
          _context2.n = 1;
          return caches.open(CACHE_NAME);
        case 1:
          cache = _context2.v;
        ...
        case 2:
          ...
          if (keys.length >= ASSETS_TO_CACHE.length) sendMessageToClients({
            type: "CACHE_DONE"
          });
        case 3:
